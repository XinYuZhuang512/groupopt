...
trainer_for() {
  local model="$1"
  case "${model}" in
    transformer_ln) TRAINER="experiments/train/train_transformer_ln_experiment.py"; LAYERS=3 ;;
    gat) TRAINER="experiments/train/train_gat_experiment.py"; LAYERS=3 ;;
    pointerformer) TRAINER="experiments/train/train_pointerformer_experiment.py"; LAYERS=3 ;;
    gru) TRAINER="experiments/train/train_gru_experiment.py"; LAYERS=1 ;;
...
"${PYTHON_BIN}" experiments/analysis/summarize_model_breadth.py \
