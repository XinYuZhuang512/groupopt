...
for mode in "${MODES[@]}"; do
  run_name="pointerformer_tsp50_${mode}_seed1234"
  run_dir="artifacts/encoder_controls/pilot/${run_name}"
  output_dir="artifacts/encoder_controls/independent_test/iid_tsp50_seed${TEST_SEED}/pointerformer_tsp50_${mode}_10k_seed1234"
